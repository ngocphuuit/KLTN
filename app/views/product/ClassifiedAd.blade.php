...
{{ HTML::style('public/css/styleSlide.css');}}
<style type="text/css">
.selectbox{
    ...
    <div class="main-ad">
                          ...
                          <h4 class="panel-title">
                            <div class="title-news">
                              <div class="block-title">
                                <div class="inline eclip"  style="margin-bottom:10px;" data-toggle="collapse" data-parent="#accordion" href="#{{$k+1}}" title="{{$value->art_title}}"><strong>{{$value->art_title}}</strong></div>
                                </div>
                                <a href="{{asset('articles')}}/{{$value->category_name}}/{{$value->art_id}}" class="inline">Xem chi tiết</a>
                              </div>
                              <div class="clearfix"></div>
                            <div class="price">Giá {{$value->art_cost}} VNĐ</div>
                          </h4>
                          <div class="info-ad">
                            <div class="user-nnews c999">Người đăng <strong style="color:#8f6b51">{{$value->username}}</strong></div>
                            <div class="sdt c999">SĐT <strong style="color:#8f6b51">{{$value->phone}}</strong></div>
                          </div>
                          <div class="count-view">
                            Lượt xem <strong style="color:#8f6b51">{{$value->daxem}}</strong>
                          </div>
                          <div class="count-view" style="width:170px">
                            Ngày đăng <p><strong style="color:#8f6b51">{{$value->date_post}}</strong>
                          </div>
                        </div>
                      ...
                      <li class="panel panel-default " >
                        <div class="panel-heading pointer">
                          <h4 class="panel-title">
                            <div class="title-news">
                              <div class="block-title">
                                <div class="inline eclip" style="margin-bottom:10px;" data-toggle="collapse" data-parent="#accordion" href="#{{$k+1000}}" title="{{$value->art_title}}"><strong>{{$value->art_title}}</strong></div>
                                </div>
                                <a href="{{asset('articles')}}/{{$value->category_name}}/{{$value->art_id}}" class="inline">Xem chi tiết</a>
                              </div>
                              <div class="clearfix"></div>
                      ...
                      <li class="panel panel-default " >
                        <div class="panel-heading pointer">
                          <h4 class="panel-title">
                            <div class="title-news">
                              <div class="block-title">
                                <div class="inline eclip" style="margin-bottom:10px;" data-toggle="collapse" data-parent="#accordion" href="#{{$k+100000}}" title="{{$value->art_title}}"><strong>{{$value->art_title}}</strong></div>
                                </div>
                                <a href="{{asset('articles')}}/{{$value->category_name}}/{{$value->art_id}}" class="inline">Xem chi tiết</a>
                              </div>
                              <div class="clearfix"></div>
                      ...
                      <li class="panel panel-default " >
                        <div class="panel-heading pointer">
                          <h4 class="panel-title">
                            <div class="title-news">
                              <div class="block-title">
                                <div class="inline eclip" style="margin-bottom:10px;" data-toggle="collapse" data-parent="#accordion" href="#{{$k+10000000}}" title="{{$value->art_title}}"><strong>{{$value->art_title}}</strong></div>
                                </div>
                                <a href="{{asset('articles')}}/{{$value->category_name}}/{{$value->art_id}}" class="inline">Xem chi tiết</a>
                              </div>
                              <div class="clearfix"></div>
                      ...
                      <li class="panel panel-default " >
                        <div class="panel-heading pointer">
                          <h4 class="panel-title">
                            <div class="title-news">
                              <div class="block-title">
                                <div class="inline eclip" style="margin-bottom:10px;" data-toggle="collapse" data-parent="#accordion" href="#{{$k+100000000}}" title="{{$value->art_title}}"><strong>{{$value->art_title}}</strong></div>
                                </div>
                                <a href="{{asset('articles')}}/{{$value->category_name}}/{{$value->art_id}}" class="inline">Xem chi tiết</a>
                              </div>
                              <div class="clearfix"></div>
      ...
      <div class="col-md-4">
        <div class="txtProduct">
          <form class="data-form" name="search" method="POST" action="{{asset('product/keyword/all')}}">
          <div class="input-group">
              <input type="search" name="keyword" class="form-control search" placeholder="Nhập từ khóa" >
              <div class="input-group-btn">
                <input type="submit" class="form-control btn-warning" value="Tìm">
              </div>
          </div>
          </form>
        </div>
        <section id="slideshow" style="margin-top: 40px;">
            ...
            <div class="containerSlide">
              ...
              <div class="slider">
                 @foreach($showProductAd as $value)
                <a href="{{asset('product/details')}}/{{$value->product_id}}">
                <figure>
                  <span class="new-icon">
                      {{HTML::image('/public/img/icon/newprd.png','', array('style'=>'width:60px; height:60px;'));}}
                  </span>
                  <img src="{{asset('public/uploads/product')}}/{{$value->img_url}}" alt="" width="290" height="155" />
                  <figcaption>{{$value->product_name}}</figcaption>
                </figure></a>
                @endforeach
              </div>
            </div>
      ...
      <div class="side">
                            <div class="border-title">
                            <h4>Bài đăng được nhiều người xem</h4>
                            </div>
                            @foreach($showart as $showarts)
                            <div class="entry">
                                <div class="entry-right" style="float:left;width:300px">
                                    <h3><a href="{{asset('articles')}}/{{$showarts->category_name}}/{{$showarts->art_id}}" class="newprd-name">{{$showarts->art_title}}</a></h3>
                                    <div class="newprd-price">Số lượt xem: {{$showarts->daxem}}</div>
                                </div>
                            </div>
                            @endforeach
                        </div><!--end:side-->
