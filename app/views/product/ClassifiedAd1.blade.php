                ...
                <div class="tab-pane fade active in" id="all">
                  ...
                  <ul class="panel-group" id="accordion">
                      <li class="panel panel-default " >
                        <div class="panel-heading pointer" data-toggle="collapse" data-parent="#accordion" href="#1">
                          <h4 class="panel-title">
                            <div class="title-news">
                            Mua bán điện thoại(<a href="#">Xem chi tiết</a>)
                            </div>
                      ...
                      <li class="panel panel-default " >
                        <div class="panel-heading pointer" data-toggle="collapse" data-parent="#accordion" href="#2">
                          <h4 class="panel-title">
                            <div class="title-news">
                            Mua bán điện thoại(<a href="#">Xem chi tiết</a>)
                            </div>
                      ...
                      <li class="panel panel-default " >
                        <div class="panel-heading pointer" data-toggle="collapse" data-parent="#accordion" href="#3">
                          <h4 class="panel-title">
                            <div class="title-news">
                            Mua bán điện thoại(<a href="#">Xem chi tiết</a>)
                            </div>
                      ...
                      <li class="panel panel-default " >
                        <div class="panel-heading pointer" data-toggle="collapse" data-parent="#accordion" href="#4">
                          <h4 class="panel-title">
                            <div class="title-news">
                            Mua bán điện thoại(<a href="#">Xem chi tiết</a>)
                            </div>
                      ...
                      <li class="panel panel-default " >
                        <div class="panel-heading pointer" data-toggle="collapse" data-parent="#accordion" href="#5">
                          <h4 class="panel-title">
                            <div class="title-news">
                            Mua bán điện thoại(<a href="#">Xem chi tiết</a>)
                            </div>
                      ...
                      <li class="panel panel-default">
                        <div class="panel-heading pointer" data-toggle="collapse" data-parent="#accordion" href="#6">
                          <h4 class="panel-title">
                            <div class="title-news">
                            Mua bán điện thoại(<a href="#">Xem chi tiết</a>)
                            </div>
                          ...
                          <div class="info-ad">
                            <div class="user-nnews">Yến nhi</div>
                            <div class="sdt">099229999</div>
                          </div>
                          <div class="count-view">
                            1
                          </div>
