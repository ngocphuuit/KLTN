            ...
            <div class="arrow_box1" style="height: 10px;"></div>
                      <div class="panel-body blue-deep pdg15">
                        <div class="list-intro">
                            ...
                            <ul>
                                <li>
                                    <a href="{{asset('articles/điện thoại')}}">Cần bán</a>
                                </li>
                                <li>
                                    <a href="{{asset('articles/điện thoại')}}">Cần mua</a>
                                </li>
                                <li>
                                <a href="{{asset('articles/điện thoại')}}">Sửa chữa - Cài đặt</a>
                                </li>
                                <li>
                                <a href="{{asset('articles/điện thoại')}}">Khác</a>
                                </li>
                            </ul>
           ...
           <div class="arrow_box2" style="height: 10px;"></div>
                      <div class="panel-body blue-white pdg15">
                        <div class="list-intro">
                            ...
                            <ul>
                                <li>
                                <a href="{{asset('articles/Máy tính bảng')}}">Cần bán</a>
                                </li>
                                <li>
                                <a href="{{asset('articles/Máy tính bảng')}}">Cần mua</a>
                                </li>
                                <li>
                                <a href="{{asset('articles/Máy tính bảng')}}">Sửa chữa - Cài đặt</a>
                                </li>
                                <li>
                                <a href="{{asset('articles/Máy tính bảng')}}">Khác</a>
                                </li>
                            </ul>
                            <div class="small-list">
                            <ul>
            ...
            <div class="arrow_box3" style="height: 10px;"></div>
                      <div class="panel-body green-deep">
                        <div class="list-intro">
                            ...
                            <ul>
                                <li>
                                <a href="{{asset('articles/Điện tử')}}">Cần bán</a>
                                </li>
                                <li>
                                <a href="{{asset('articles/Điện tử')}}">Cần mua</a>
                                </li>
                                <li>
                                <a href="{{asset('articles/Điện tử')}}">Sửa chữa - Cài đặt</a>
                                </li>
                                <li>
                                <a href="{{asset('articles/Điện tử')}}">Khác</a>
                                </li>
                            </ul>
                            <div class="small-list">
                            <ul>
            ...
            <div class="arrow_box4" style="height: 10px;"></div>
                      ...
                      <ul>
                          <li><a href="{{asset('articles/Khác')}}">Các mặt hàng khác</a></li>
                      </ul>
            ...
            { ?>
                <div class="new-prd new-border bubbleInfo">
                    ...
                    <div class="popup row show-grid">
                        ...
                        <a href="{{asset('product/details')}}/{{$value->product_id}}" style="color:white; font-weight:bold;" title="{{$value->product_name}}">{{$value->product_name}}</a>
                        </div>
