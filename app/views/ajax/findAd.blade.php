            ...
            <div class="col-md-8">
              ...
              <div id="myTabContent" class="tab-content">
                <div class="tab-pane fade active in" id="all">
                  ...
                  <div id="change">
                  @foreach($findAd as $k => $value)
                      <li class="panel panel-default " >
                        <div class="panel-heading pointer">
                          <h4 class="panel-title">
                            <div class="title-news">
                              <div class="block-title">
                                <div class="inline eclip" data-toggle="collapse" data-parent="#accordion" href="#{{$k+1}}" title="{{$value->art_title}}"><strong>{{$value->art_title}}</strong></div>
                                </div>
                        ...
                        <div id="{{$k+1}}" class="panel-collapse collapse">
                          <div class="panel-body">
                            ...
                            <div class="info-user">
                                ...
                                <div class="detail-info">Phạm vi rao: {{$value->province_name}}</div>
                            </div>
                          </div>
                        </div>
                      </li>
                      ...
                      <li class="panel panel-default " >
                        <div class="panel-heading pointer">
                          <h4 class="panel-title">
                            <div class="title-news">
                              <div class="block-title">
                                <div class="inline eclip" data-toggle="collapse" data-parent="#accordion" href="#{{$k+1000}}" title="{{$value->art_title}}"><strong>{{$value->art_title}}</strong></div>
                                </div>
                                <a href="{{asset('articles')}}/{{$value->category_name}}/{{$value->art_id}}" class="inline">Xem chi tiết</a>
                              </div>
                              <div class="clearfix"></div>
                      ...
                      <li class="panel panel-default " >
                        <div class="panel-heading pointer">
                          <h4 class="panel-title">
                            <div class="title-news">
                              <div class="block-title">
                                <div class="inline eclip" data-toggle="collapse" data-parent="#accordion" href="#{{$k+100000}}" title="{{$value->art_title}}"><strong>{{$value->art_title}}</strong></div>
                                </div>
                                <a href="{{asset('articles')}}/{{$value->category_name}}/{{$value->art_id}}" class="inline">Xem chi tiết</a>
                              </div>
                              <div class="clearfix"></div>
                      ...
                      <li class="panel panel-default " >
                        <div class="panel-heading pointer">
                          <h4 class="panel-title">
                            <div class="title-news">
                              <div class="block-title">
                                <div class="inline eclip" data-toggle="collapse" data-parent="#accordion" href="#{{$k+10000000}}" title="{{$value->art_title}}"><strong>{{$value->art_title}}</strong></div>
                                </div>
                                <a href="{{asset('articles')}}/{{$value->category_name}}/{{$value->art_id}}" class="inline">Xem chi tiết</a>
                              </div>
                              <div class="clearfix"></div>
                      ...
                      <li class="panel panel-default " >
                        <div class="panel-heading pointer">
                          <h4 class="panel-title">
                            <div class="title-news">
                              <div class="block-title">
                                <div class="inline eclip" data-toggle="collapse" data-parent="#accordion" href="#{{$k+100000000}}" title="{{$value->art_title}}"><strong>{{$value->art_title}}</strong></div>
                                </div>
                                <a href="{{asset('articles')}}/{{$value->category_name}}/{{$value->art_id}}" class="inline">Xem chi tiết</a>
                              </div>
                              <div class="clearfix"></div>
